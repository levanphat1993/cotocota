         ...
         <section class="hero-wrap style1 bg-cod-grey">
            <img src="<?= Yii::getAlias('@web').'/hibootstrap/img/hero/hero-shape-1.png' ?>" alt="Image" class="hero-shape-1">
            <img src="<?= Yii::getAlias('@web').'/hibootstrap/img/hero/hero-shape-2.png' ?>" alt="Image" class="hero-shape-2">
            <img src="<?= Yii::getAlias('@web').'/hibootstrap/img/hero/hero-shape-31.png' ?>" alt="Image" class="hero-shape-3 md-none">
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="hero-content">
                        ...
                        <p>In shakes item of 2021 we are offering
                           20% flat discount. Don't miss out!!
                        </p>
                        <div class="hero-btn">
                  ...
                  <div class="col-lg-6">
                     <div class="hero-img-wrap">
                        <img src="hibootstrap/img/hero/hero-img-1.png" alt="Image">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row gx-5 align-items-center">
                  <div class="col-lg-6">
                     <div class="about-img-wrap">
                        <img src="hibootstrap/img/about/about-shape-1.png" alt="Image" class="abouut-shape-1 md-none">
                        <img src="hibootstrap/img/about/about-shape-2.png" alt="Image" class="abouut-shape-2 md-none">
                        <img src="hibootstrap/img/about/about-shape-3.png" alt="Image" class="abouut-shape-3 md-none">
                  ...
                  <div class="col-lg-6">
                     <div class="about-content">
                        <div class="content-title style2 mb-15">
                           <span>
                           <img src="hibootstrap/img/secion-shape-1.png" alt="Image">
                           Our Story
                           <img src="hibootstrap/img/secion-shape-2.png" alt="Image">
                           </span>
                        ...
                        <p>In our restaurant with people who are important to you, conversations that bring you
                           ...
                           Chops Sicilian, spicy Lobster Fra Diazole, tender Chicken Contadina.
                        </p>
                        <img src="hibootstrap/img/about/author-sign.png" alt="Image">
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="service-card-wrap">
                        <div class="service-card style1">
                           <div class="service-img">
                              <img src="hibootstrap/img/service/breakfast.png" alt="Image">
                           </div>
                        ...
                        <div class="service-card style1">
                           <div class="service-img">
                              <img src="hibootstrap/img/service/lunch.png" alt="Image">
                           </div>
                           <div class="service-info">
                        ...
                        <div class="service-card style1">
                           <div class="service-img">
                              <img src="hibootstrap/img/service/dinner.png" alt="Image">
                           </div>
                           <div class="service-info">
                        ...
                        <div class="service-card style1">
                           <div class="service-img">
                              <img src="hibootstrap/img/service/custom.png" alt="Image">
                           </div>
                           <div class="service-info">
         ...
         <section class="feature-wrap style1 pt-100 pb-70 bg-1 pos-rel">
            <div class="feature-top-shape bg-f">
               <img src="hibootstrap/img/shape-1.png" alt="Image" class="feature-top-shape-1 md-none">
               <img src="hibootstrap/img/shape-2.png" alt="Image" class="feature-top-shape-2 md-none">
            ...
            <div class="container pos-rel">
               <div class="row justify-content-center">
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-1.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
                           ...
                           <div class="discount-tag">
                              <img src="hibootstrap/img/feature/circle-1.png" alt="Image">
                              <p> <span>Save</span>
                                 30%
                              </p>
                           </div>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-2.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-3.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-4.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-5.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-img">
                           <img src="hibootstrap/img/feature/feature-item-6.jpg" alt="Image">
                        </div>
                        <div class="feature-info">
               ...
               <div class="row gx-5 align-items-center">
                  <div class="col-lg-6">
                     <div class="delivery-content">
                        ...
                        <p>In our restaurant with people who are important to you, conversations that bring you to
                           ...
                           velit eget dictum. Integer ornare magna.
                        </p>
                        <div class="row align-items-end gx-5">
                           ...
                           <div class="col-md-4 sm-none">
                              <div class="del-img">
                                 <img src="hibootstrap/img/fruit-1.png" alt="Image">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-6">
                     <div class="delivery-van-img">
                        <img src="hibootstrap/img/delivery/car.png" alt="Image">
                     </div>
                  </div>
               </div>
            </div>
         ...
         <section class="contact-wrap style1 bg-f contact-bg-1 pt-100 pb-70 pos-rel">
            ...
            <img src="hibootstrap/img/shape-1.png" alt="Iamge" class="contact-shape-1 lg-none">
            <img src="hibootstrap/img/shape-2.png" alt="Iamge" class="contact-shape-2 lg-none">
            <div class="section-title style6 text-center mb-40">
               ...
               <div class="row">
                  <div class="col-xl-10 offset-xl-1">
                     <div class="contact-box-wrap">
                        ...
                        <div class="contact-box">
                           <h5>Mail Us</h5>
                           <a href="mainto:hello@caban.com"><span class="__cf_email__" data-cfemail="f49c9198989bb4979596959ada979b99">[email&#160;protected]</span></a>
                           <img src="hibootstrap/img/contact/contact-img-1.png" alt="Image">
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="testimonial-slider-one swiper-container">
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="testimonial-item style1">
                                 <div class="client-img">
                                    <img src="hibootstrap/img/testimonial/client-1.jpg" alt="Image">
                                 </div>
                                 ...
                                 <div class="client-quote">
                                    <p>The food is really very tasty – the wagyu sushi on the dinner menu is
                                       especially delicious and not to be missed for a long time!
                                    </p>
                                 </div>
                           ...
                           <div class="swiper-slide">
                              <div class="testimonial-item style1">
                                 <div class="client-img">
                                    <img src="hibootstrap/img/testimonial/client-2.jpg" alt="Image">
                                 </div>
                                 <div class="client-info">
                           ...
                           <div class="swiper-slide">
                              <div class="testimonial-item style1">
                                 <div class="client-img">
                                    <img src="hibootstrap/img/testimonial/client-3.jpg" alt="Image">
                                 </div>
                                 <div class="client-info">
                                    <h4>Tony Stark</h4>
                                    <span>Traveler</span>
                           ...
                           <div class="swiper-slide">
                              <div class="testimonial-item style1">
                                 <div class="client-img">
                                    <img src="hibootstrap/img/testimonial/client-4.jpg" alt="Image">
                                 </div>
                                 <div class="client-info">
                                    <h4>Henry Orton</h4>
         ...
         <section class="app-wrap style1 ptb-100 bg-f app-bg-1">
            ...
            <img src="hibootstrap/img/shape-1.png" alt="Image" class="app-shape-1 lg-none">
            <img src="hibootstrap/img/shape-2.png" alt="Image" class="app-shape-2 lg-none">
            <div class="container">
               <div class="row gx-5 align-items-center">
                  <div class="col-lg-6">
                     <div class="app-content">
                        ...
                        <div class="download-app-btn">
                           <a href="app.html"><img src="hibootstrap/img/app/google-playstore.png" alt="Image"></a>
                           <a href="app.html"><img src="hibootstrap/img/app/apple-playstore.png" alt="Image"></a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="app-img">
                        <img src="hibootstrap/img/app/app-img-1.png" alt="Image" class="app-top-img md-none">
                        <img src="hibootstrap/img/app/app-showcase.png" alt="Image">
                     </div>
                  </div>
               </div>
            </div>
