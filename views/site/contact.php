         ...
         <div class="row gx-5">
            <div class="col-md-12">
               <div class="contact-form">
                  <form action="https://templates.hibootstrap.com/caban/default/php/form-process.php" class="form-wrap" id="contactForm">
                     <div class="row">
                        <div class="col-lg-6">
         ...
         <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
               <div class="contact-card">
                  ...
                  <div class="contact-info">
                     <h4>Our Email</h4>
                     <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#264e434a4a496645474447480845494b"><span class="__cf_email__" data-cfemail="4129242d2d2e01222023202f6f222e2c">[email&#160;protected]</span></a>
                  </div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
